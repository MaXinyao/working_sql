SELECT 
    ...
    ,CASE WHEN fea_x.newusers > 0 THEN fea_x.r7users/fea_x.newusers ELSE 0 END AS retention7
    ,CASE WHEN fea_x.newusers > 0 THEN fea_x.r10users/fea_x.newusers ELSE 0 END AS retention10
    ,CASE WHEN fea_x.newusers > 0 THEN fea_x.r14users/fea_x.newusers ELSE 0 END AS retention14
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.rev7/fea_x.r7users ELSE 0 END AS arpu7
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.rev10/fea_x.r10users ELSE 0 END AS arpu10
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.rev14/fea_x.r14users ELSE 0 END AS arpu14
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.duration_sec7/fea_x.r7users ELSE 0 END AS duration_sec7_pu
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.duration_sec10/fea_x.r10users ELSE 0 END AS duration_sec10_pu
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.duration_sec14/fea_x.r14users ELSE 0 END AS duration_sec14_pu
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.crush_rows7/fea_x.r7users ELSE 0 END AS crush_rows7_pu
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.crush_rows10/fea_x.r10users ELSE 0 END AS crush_rows10_pu
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.crush_rows14/fea_x.r14users ELSE 0 END AS crush_rows14_pu
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.crush_times7/fea_x.r7users ELSE 0 END AS crush_times7_pu
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.crush_times10/fea_x.r10users ELSE 0 END AS crush_times10_pu
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.crush_times14/fea_x.r14users ELSE 0 END AS crush_times14_pu
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.combo_times7/fea_x.r7users ELSE 0 END AS combo_times7_pu
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.combo_times10/fea_x.r10users ELSE 0 END AS combo_times10_pu
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.combo_times14/fea_x.r14users ELSE 0 END AS combo_times14_pu
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.game_num7/fea_x.r7users ELSE 0 END AS game_num7_pu
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.game_num10/fea_x.r10users ELSE 0 END AS game_num10_pu
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.game_num14/fea_x.r14users ELSE 0 END AS game_num14_pu
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.best_record7/fea_x.r7users ELSE 0 END AS best_record7_pu
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.best_record10/fea_x.r10users ELSE 0 END AS best_record10_pu
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.best_record14/fea_x.r14users ELSE 0 END AS best_record14_pu
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.round_num7/fea_x.r7users ELSE 0 END AS round_num7_pu
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.round_num10/fea_x.r10users ELSE 0 END AS round_num10_pu
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.round_num14/fea_x.r14users ELSE 0 END AS round_num14_pu
    ...
    ,CASE WHEN fea_x.r7users > 0 THEN fea_x.holder_out7/fea_x.r7users ELSE 0 END AS holder_out7_pu
    ,CASE WHEN fea_x.r10users > 0 THEN fea_x.holder_out10/fea_x.r10users ELSE 0 END AS holder_out10_pu
    ,CASE WHEN fea_x.r14users > 0 THEN fea_x.holder_out14/fea_x.r14users ELSE 0 END AS holder_out14_pu
    ,y.living_days
    ,y.sum_rev
...
FROM
    (SELECT 
        ...
        ,SUM(CASE WHEN living_days = 7 THEN retended ELSE 0 END) AS r7users
        ,SUM(CASE WHEN living_days = 10 THEN retended ELSE 0 END) AS r10users
        ,SUM(CASE WHEN living_days = 14 THEN retended ELSE 0 END) AS r14users 
        ...
        ,SUM(CASE WHEN living_days = 7 THEN rev ELSE 0 END) AS rev7
        ,SUM(CASE WHEN living_days = 10 THEN rev ELSE 0 END) AS rev10
        ,SUM(CASE WHEN living_days = 14 THEN rev ELSE 0 END) AS rev14
        ...
        ,SUM(CASE WHEN living_days = 7 THEN duration_sec ELSE 0 END) AS duration_sec7 
        ,SUM(CASE WHEN living_days = 10 THEN duration_sec ELSE 0 END) AS duration_sec10
        ,SUM(CASE WHEN living_days = 14 THEN duration_sec ELSE 0 END) AS duration_sec14
        ...
        ,SUM(CASE WHEN living_days = 7 THEN crush_rows ELSE 0 END) AS crush_rows7 
        ,SUM(CASE WHEN living_days = 10 THEN crush_rows ELSE 0 END) AS crush_rows10
        ,SUM(CASE WHEN living_days = 14 THEN crush_rows ELSE 0 END) AS crush_rows14
        ...
        ,SUM(CASE WHEN living_days = 7 THEN crush_times ELSE 0 END) AS crush_times7 
        ,SUM(CASE WHEN living_days = 10 THEN crush_times ELSE 0 END) AS crush_times10
        ,SUM(CASE WHEN living_days = 14 THEN crush_times ELSE 0 END) AS crush_times14
        ...
        ,SUM(CASE WHEN living_days = 7 THEN combo_times ELSE 0 END) AS combo_times7 
        ,SUM(CASE WHEN living_days = 10 THEN combo_times ELSE 0 END) AS combo_times10
        ,SUM(CASE WHEN living_days = 14 THEN combo_times ELSE 0 END) AS combo_times14
        ...
        ,SUM(CASE WHEN living_days = 7 THEN game_num ELSE 0 END) AS game_num7
        ,SUM(CASE WHEN living_days = 10 THEN game_num ELSE 0 END) AS game_num10
        ,SUM(CASE WHEN living_days = 14 THEN game_num ELSE 0 END) AS game_num14
        ...
        ,SUM(CASE WHEN living_days = 7 THEN best_record ELSE 0 END) AS best_record7 
        ,SUM(CASE WHEN living_days = 10 THEN best_record ELSE 0 END) AS best_record10
        ,SUM(CASE WHEN living_days = 14 THEN best_record ELSE 0 END) AS best_record14
        ...
        ,SUM(CASE WHEN living_days = 7 THEN round_num ELSE 0 END) AS round_num7 
        ,SUM(CASE WHEN living_days = 10 THEN round_num ELSE 0 END) AS round_num10
        ,SUM(CASE WHEN living_days = 14 THEN round_num ELSE 0 END) AS round_num14
        ...
        ,SUM(CASE WHEN living_days = 7 THEN holder_out ELSE 0 END) AS holder_out7
        ,SUM(CASE WHEN living_days = 10 THEN holder_out ELSE 0 END) AS holder_out10
        ,SUM(CASE WHEN living_days = 14 THEN holder_out ELSE 0 END) AS holder_out14
    FROM 
        (SELECT  
            * 
        FROM `blockpuzzle-f21e1.warehouse.campaign_review_android_median_table_di`
        WHERE living_days BETWEEN 0 AND 14
